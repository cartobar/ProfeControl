      ...
      <main className="max-w-7xl mx-auto px-6 py-10">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-10">
          <div>
            ...
            <h2 className="text-3xl font-bold">Crear Tareas</h2>
            <p className="text-gray-600 dark:text-gray-400 mt-2">
              Aqui podras crear tareas, proyectos y examenes por grado.
            </p>
          </div>
        ...
        <section className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-3xl p-8">
          <p className="text-gray-700 dark:text-gray-300">
            Pantalla lista para conectar gestion de tareas.
          </p>
        </section>
      </main>
    </div>
